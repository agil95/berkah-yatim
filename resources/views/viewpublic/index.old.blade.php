    ...
    <nav class="navbar navbar-default navbar-fixed-top" id="twd-menu">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="{{route('index')}}">Berkah Yatim</a>
        </div>
  ...
  <div class="container box">
    <div>
      <div class="col-md-3 col-md-offset-1">
        <div class="opinion">
          <h1 class="text-left">Program Kerja Berkah Yatim</h1>
    ...
    <div class="container footer">
      <div class="row">
        <div class="col-lg-5 col-md-offset-1">
          <p class="brand-footer">Berkah Yatim</p>
        </div>
  ...
  <footer>
    <div class="container end">
      <div class="row">
        <div class="col-lg-5 col-md-offset-1">
          <p class="ft">
            <span class="brand-explain">Berkah Yatim</span>
            <span class="explain">
        ...
        <div class="col-lg-4 col-md-offset-2 lock">
          ...
          <div>
            <p class="lock-2">
              <span class="ti-email mr-3"></span> berkahyatim@gmail.com
            </p>
          </div>
          <div>
            <p class="lock-3">
