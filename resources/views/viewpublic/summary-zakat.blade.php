...
<section class="section py-l">
  ...
  <div class="by-alert by-alert--gray-ghost py-l mt-l">
    Transfer sebelum hari <strong>{{$donasi->created_at->addHours(6)->formatLocalized('%A, %e %B %G %H:%M')}}</strong> atau zakat kamu otomatis dibatalkan oleh sistem.
  </div>
</section>
...
<section class="section py-l">
  ...
  <div class="summary-share mt-l">
    <a target="_blank" href="https://api.whatsapp.com/send?text=Ayo bersihkan harta kamu dengan zakat%20{{url('kalkulator-zakat')}}" class="btn btn--primary btn--block btn--wa mb-l">
      <img src="{{ asset('dist/img/ico-whatsapp-white.svg') }}" class="btn__img-prepend" alt="facebook">
      Share
    </a>
    <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{url('kalkulator-zakat')}}" class="btn btn--primary btn--block btn--fb mb-l">
