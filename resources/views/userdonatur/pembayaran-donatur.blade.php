...
@section ('title')Berkah Yatim - upload bukti pembayaran @endsection
@section('content')
<section>
    <div class="dashboard">
        <div class="container">
            <div class="col-md-3 col-md-offset-1">
                ...
                <div class="list-group">
                    ...
                    <a href="{{route('donasi.penyaluran') }}" class="list-group-item">Penyaluran</a>                  
                    <a href="{{route('edit.profile')}}" class="list-group-item">Edit Profil</a>
                    <a href="{{route('edit.password')}}" class="list-group-item">Edit Password</a>
            ...
            <div class="col-md-5 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form action="{{route('konfirmasi.bayar',['id' => $id])}}" method="POST" enctype="multipart/form-data">
                            @csrf
