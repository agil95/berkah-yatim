...
@section ('title')Berkah Yatim - info transfer @endsection
@section('content')
<section>
    <div class="dashboard">
        <div class="container">
            ...
            <div class="col-md-6 col-md-offset-1">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <p class="text-center transfer">Transfer ke rekening a/n <b>Berkah Yatim</b> berikut ini :</p>
                        <div class="cobtainer">
                            <div class="row border">
                                <div class="col-md-5 col-md-offset-1">
                                    <img src="{{asset('img/bri.png')}}" alt="BRI" class="img-responsive bri">
                                </div>
                                <div class="col-md-6">
