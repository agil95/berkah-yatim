...
@section ('title')Berkah Yatim - daftar mitra @endsection
@section('content')
<section>
    <div class="dashboard">
        <div class="container">
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <!-- <a href="{{route('daftar.mitra')}}" class="list-group-item active">Lihat daftar mitra Berkah Yatim</a> -->
            ...
            <div class="col-md-9">
                <h2 style="margin-top:40px;">Daftar Mitra Berkah Yatim</h2>
