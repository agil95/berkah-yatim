        ...
        <nav class="navbar navbar-dark">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">Berkah Yatim</a>
                </div>
            </div>
        </nav>
    </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Daftar Sebagai Donatur22!</h4>
                        </div>
                        <form action="confirm-add.php" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><span class="ti ti-user"></span></div>
                                        <input type="radio" name="jkel" value="L">Laki-laki </input>
                                        <input type="radio" name="jkel" value="P">Perempuan </input>
                                    </div>
                                    <div class="input-group">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary submit-mod" data-dismiss="modal">Batal</button>
                                <button type="submit" class="btn btn-danger submit-mod-tambah">Tambah</a>
                            </div>
                        </form>
                    </div>
                </div>
